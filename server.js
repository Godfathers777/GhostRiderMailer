...
/* ── Build invitation HTML — template lives here, not in EmailJS ── */
              ...
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" valign="middle"
                    style="width:38px;height:38px;border-radius:50%;background-color:#c8a032;font-family:Georgia,serif;font-size:13px;font-weight:700;font-style:italic;color:#ffffff;text-align:center;line-height:38px;">
                    ${senderInitials}
                  </td>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border-radius:10px;overflow:hidden;">
              ...
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="border-radius:5px;background-color:#c8a032;">
                    <a href="https://occasion.rf.gd/" target="_blank"
                      style="display:inline-block;padding:15px 40px;font-family:Arial,sans-serif;font-size:12px;font-weight:700;color:#ffffff;letter-spacing:2px;text-transform:uppercase;text-decoration:none;border-radius:5px;">
                      Open Invitation
                    </a>
                  </td>
                  <td width="12">&nbsp;</td>
                  <td style="border-radius:5px;border:1.5px solid #1a2535;">
                    <a href="https://occasion.rf.gd/" target="_blank"
                      style="display:inline-block;padding:14px 32px;font-family:Arial,sans-serif;font-size:12px;font-weight:700;color:#1a2535;letter-spacing:2px;text-transform:uppercase;text-decoration:none;border-radius:5px;">
                      RSVP Now
                    </a>
                  </td>
                </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="padding-left:16px;">
                    <p style="margin:0 0 8px;font-family:Georgia,serif;font-size:14px;font-style:italic;color:#666666;line-height:1.8;">
                      "I thought of you specifically for this. It would not feel the same without you there."
                    </p>
                    <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;color:#b0a898;font-weight:600;letter-spacing:1px;text-transform:uppercase;">
                      ${senderName}
                    </p>
                  </td>
                </tr>
          ...
          <tr>
            <td align="center" style="padding:16px 44px 22px;background-color:#ffffff;">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding:0 12px;"><a href="https://occasion.rf.gd/" target="_blank" style="font-family:Arial,sans-serif;font-size:11px;color:#7a9e8a;font-weight:700;letter-spacing:1px;text-transform:uppercase;text-decoration:none;">Invitation</a></td>
                  <td style="font-family:Arial,sans-serif;font-size:13px;color:#d8d4cc;">·</td>
                  <td style="padding:0 12px;"><a href="https://occasion.rf.gd/" target="_blank" style="font-family:Arial,sans-serif;font-size:11px;color:#7a9e8a;font-weight:700;letter-spacing:1px;text-transform:uppercase;text-decoration:none;">RSVP</a></td>
                  <td style="font-family:Arial,sans-serif;font-size:13px;color:#d8d4cc;">·</td>
                  <td style="padding:0 12px;"><a href="https://occasion.rf.gd/" target="_blank" style="font-family:Arial,sans-serif;font-size:11px;color:#7a9e8a;font-weight:700;letter-spacing:1px;text-transform:uppercase;text-decoration:none;">Message</a></td>
                </tr>
              </table>
            </td>
          </tr>
...
<tr><td align="center" style="padding:40px 16px;">
  <table width="520" cellpadding="0" cellspacing="0" border="0" style="max-width:520px;background-color:#ffffff;border-radius:8px;overflow:hidden;">
    <tr>
      <td style="height:4px;background-color:#1a2535;font-size:0;">&nbsp;</td>
    </tr>
    <tr>
      <td style="padding:36px 40px 28px;">
        <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
          <tr>
            <td align="center" valign="middle"
              style="width:44px;height:44px;border-radius:50%;background-color:#c8a032;font-family:Georgia,serif;font-size:14px;font-weight:700;font-style:italic;color:#ffffff;text-align:center;line-height:44px;">
              ${senderInitials}
            </td>
    ...
    <tr>
      <td style="height:4px;background-color:#c8a032;font-size:0;">&nbsp;</td>
    </tr>
    <tr>
